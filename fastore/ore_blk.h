...
/**
 * Initializes an ore_blk_params type by setting its parameters, the number of
 * bits and block length.
 *
...
/**
 * Initializes the secret key of the ORE scheme (with respect to a specific set
 ...
 * @param params The public parameters for the ORE scheme (should be
 * initialized)
 *
 ...
 *
 * This function assumes that init_ore_blk_params has been called on the
 * parameters.
 *
