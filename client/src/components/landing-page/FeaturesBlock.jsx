            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-12 md:py-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        <h2 className="h2 mb-4 font-extrabold">A wide selection of categories</h2>
                        <p className="text-xl text-gray-600">With chainAuction, you can sell anything you want.</p>
                    </div>
